...
namespace HearthStone.Library.CommunicationInfrastructure.Operation.Managers
{
    public class PlayerOperationManager
    {
        ...
        internal PlayerOperationManager(Player player)
        {
            ...
            operationTable.Add(PlayerOperationCode.ServantAttack, new ServantAttackHandler(player));
            operationTable.Add(PlayerOperationCode.HeroAttack, new HeroAttackHandler(player));
